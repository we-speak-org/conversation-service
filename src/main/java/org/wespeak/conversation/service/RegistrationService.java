...
public class RegistrationService {
  ...
  public RegistrationDto register(String timeSlotId, String userId) {
    ...
    if (registrationRepository.existsByTimeSlotIdAndUserIdAndStatus(
    ...
    long activeCount =
        registrationRepository.countByUserIdAndStatus(userId, Registration.Status.registered);
    ...
    long registeredCount =
        registrationRepository.countByTimeSlotIdAndStatus(
            timeSlotId, Registration.Status.registered);
  ...
  public void unregister(String timeSlotId, String userId) {
    Registration registration =
        registrationRepository
            .findByTimeSlotIdAndUserId(timeSlotId, userId)
  ...
  public RegistrationsResponse getUserRegistrations(String userId) {
    ...
    return RegistrationsResponse.builder().registrations(dtos).build();
  }
  ...
  public List<Registration> getRegisteredUsers(String timeSlotId) {
    return registrationRepository.findByTimeSlotIdAndStatus(
        timeSlotId, Registration.Status.registered);
  }
